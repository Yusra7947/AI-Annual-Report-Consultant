...
LangChain: The "brain" that manages the conversation and document logic.
...
Run the analysis: Use the script in the src/ folder or play around with the notebook in notebooks/.
 ...
 If you're in a hurry, I've included a "Open in Colab" link in the notebooks folder so you can run it in the cloud without installing anything!
